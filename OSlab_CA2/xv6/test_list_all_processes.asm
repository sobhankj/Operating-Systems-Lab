...
_test_list_all_processes:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  1f:	e8 fc 03 00 00       	call   420 <printf>
        exit();
  24:	e8 7a 02 00 00       	call   2a3 <exit>
    }
    else{
        list_all_processes();
  29:	e8 35 03 00 00       	call   363 <list_all_processes>
...
00000353 <get_most_invoked_syscall>:
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 70 07 00 00       	mov    $0x770,%edx
        while(*s != 0){
