...
_test_sort_syscalls:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  3a:	e8 3c 03 00 00       	call   37b <sort_syscalls>
        if(return_value == -1){
  3f:	83 c4 10             	add    $0x10,%esp
  42:	83 c0 01             	add    $0x1,%eax
  45:	74 13                	je     5a <main+0x5a>
  ...
  47:	50                   	push   %eax
  48:	50                   	push   %eax
  49:	68 a2 07 00 00       	push   $0x7a2
  4e:	6a 01                	push   $0x1
  50:	e8 eb 03 00 00       	call   440 <printf>
            exit();
  55:	e8 69 02 00 00       	call   2c3 <exit>
            printf(2, "Invalid Process ID.\n");
  5a:	52                   	push   %edx
  5b:	52                   	push   %edx
  5c:	68 8d 07 00 00       	push   $0x78d
  61:	6a 02                	push   $0x2
  63:	e8 d8 03 00 00       	call   440 <printf>
            exit();
...
00000373 <get_most_invoked_syscall>:
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba b7 07 00 00       	mov    $0x7b7,%edx
        while(*s != 0){
