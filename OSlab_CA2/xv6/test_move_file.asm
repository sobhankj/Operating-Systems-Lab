...
_test_move_file:     file format elf32-i386
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba c3 07 00 00       	mov    $0x7c3,%edx
        while(*s != 0){
