...
_test_get_most_invoked:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  6d:	51                   	push   %ecx
  6e:	51                   	push   %ecx
  6f:	68 8b 07 00 00       	push   $0x78b
  74:	6a 02                	push   $0x2
  76:	e8 d5 03 00 00       	call   450 <printf>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb e8                	jmp    68 <main+0x68>
...
00000383 <get_most_invoked_syscall>:
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba e9 07 00 00       	mov    $0x7e9,%edx
        while(*s != 0){
