...
extern int sys_get_shared_mem(void);
extern int sys_attach_shared_mem(void);
extern int sys_deattach_shared_mem(void);
extern int sys_remove_shared_mem(void);
...
[SYS_get_shared_mem]  sys_get_shared_mem,
[SYS_attach_shared_mem]  sys_attach_shared_mem,
[SYS_deattach_shared_mem]  sys_deattach_shared_mem,
[SYS_remove_shared_mem] sys_remove_shared_mem,
};
